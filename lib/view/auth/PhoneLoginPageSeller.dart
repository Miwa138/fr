...
class PhoneLoginPageSeller extends StatefulWidget {
  @override
  _PhoneLoginPageSellerState createState() => _PhoneLoginPageSellerState();
}

class _PhoneLoginPageSellerState extends State<PhoneLoginPageSeller> {
  String _phoneNumber = '';
